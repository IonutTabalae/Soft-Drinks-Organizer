  ...
  <div class="middle-container">
    ...
    ?>
        ...
        <?php $numberOfDrinks = 0; $totalCalories = 0; $totalSugar = 0; $totalAllergens =''; foreach($wishlist as $item): $numberOfDrinks += 1;?>
          <?php
           ...
           <div class="product-card"> <a style="all: unset; cursor: pointer;" href="product-page.php?id=<?php echo $product[0]['id'] ?>">
             ...
             <a class="delete-button" href="includes/deleteCart.inc.php?deleteItem=<?php echo $product[0]['id'] ?>" style="float:right;">✖</a>
           </a></div>
        ...
        <div class="stats-for-nerds">
          ...
          <div class="button-export" style="float: right;">
            <p style="display: inline; ">Export as CSV: </p>
            <button onclick="window.location.href='./assets/cartData.php'" class="csv" type="button" name="button">📋</button>
